...
class MainViewController: UIViewController, TransportType, Buttons, PaymentViewProtocol, CityDropDown, MFMessageComposeViewControllerDelegate {
    ...
    let zhytomyrTram = TransportModel(transportType: "Трамвай", routeNumbers: ["91", "ДЕПО"], ticketPrice: 4, transportRoutes: ["Майдан Перемоги - Льогокомбінат", "ДЕПО"], routeTextCodes: ["SEC91", "SEC0"])
